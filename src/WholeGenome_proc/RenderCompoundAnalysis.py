...
parser.add_argument("--node_file", default="default.csv", help="Path to the node file CSV.")
parser.add_argument("--output", default="filepath.html", help="Path to HTML report file")
args = parser.parse_args()

this_dir = os.path.dirname(__file__)
rmd_path = os.path.join(this_dir, "CompoundAnalysis_KEGG.Rmd")
...
Rscript -e "rmarkdown::render(
  input = '{rmd_path}',
  params = list(node_file = '{args.node_file}'),
